...
export default function ContributorsPage() {
  ...
  return (
    <>
      ...
      {/* Title */}
      <Title size="medium" className="my-10 text-center text-3xl font-bold">
        Our Contributors
      </Title>

      {/* Grid Section */}
      <div className="mx-auto mb-12 grid max-w-7xl grid-cols-1 gap-8 px-3 sm:grid-cols-2 lg:grid-cols-4">

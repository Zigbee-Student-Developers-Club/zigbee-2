...
export default function Events() {
  return (
    <Container maxW={"7xl"}>
      ...
      <Center>
        <Image boxSize="md" objectFit={"contain"} src={EventDog.src} alt="happy dog for the event"/>
      </Center>
      <Text textAlign={"center"}>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit, aliquam.
        Consectetur deleniti repudiandae reprehenderit. Quibusdam animi adipisci
        expedita sint beatae?
      </Text>

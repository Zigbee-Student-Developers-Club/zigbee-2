      ...
      <Container maxW={'7xl'}>
        ...
        >
          <Stack flex={1} spacing={{ base: 5, md: 10 }}>
            ...
            <Text>
              Android App Development, Frontend, Backend Development, Designing,
              Networking, Full Stack, anything. Whatever is the colour of that
              feather on your hat, we&apos;ve got you covered. Choose your
              domain, and jump directly to the best resources available out
              there to help you upskill and sharpen your swords.
            </Text>
          </Stack>

  ...
  return (
    <Card p="2" m="auto" bg="purple.50" className={ResourceCardStyles.card}>
        <div className={ResourceCardStyles.card_hero}>
            <Box bg="purple.200" opacity={"0.3"}  className={`${ResourceCardStyles.blob} ${ResourceCardStyles.blob1}`}></Box>
            <Box bg="purple.200" opacity={"0.3"}  className={`${ResourceCardStyles.blob} ${ResourceCardStyles.blob2}`}></Box>
            <Box bg="purple.200" opacity={"0.3"}  className={`${ResourceCardStyles.blob} ${ResourceCardStyles.blob3}`}></Box>
